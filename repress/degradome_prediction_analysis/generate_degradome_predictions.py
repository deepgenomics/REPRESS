...
if __name__ == "__main__":
    ...
    prediction = model.predict_interval(utr3, genome, transcript=transcript, cell_lines=cell_line)[0]

    fig, ax = make_track_plot(utr3, prediction, gene, genome, figsize=(8, 2),
    ...
    save_path = analysis_dir / "plots/ENO2_degradome_track_plot.png"
